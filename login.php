...
<head>
	...
	<title>Giat Laundry | Login</title>
...
<body>
	...
	<?php if (isset($_SESSION['login']) && isset($_SESSION['master'])) : ?>
		<script>window.location='http://localhost/Giat_laundry/'</script>
	<?php endif ?> 
		...
		<div class="box-content">
			...
			<div class="col box__right">
				<div class="box__right-content">
					...
					<img src=" <?=url('_assets/img/orang1.png')?>" alt="" class="box-img-orang">
					<img src=" <?=url('_assets/img/celana1.png')?>" alt="" class="box-img-celana">
					<img src=" <?=url('_assets/img/kaos1.png')?>" alt="" class="box-img-kaos">
					<img src=" <?=url('_assets/img/kemeja1.png')?>" alt="" class="box-img-kemeja">
