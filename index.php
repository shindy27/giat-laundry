						...
						<div class="card-body">
							<div class="card-panel">
								...
								<div class="panel-icon">
									<img src="<?=url('_assets/img/karyawan.png')?>" alt="karyawan" height="48">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card">
						<div class="card-body">
							<div class="card-panel">
								...
								<div class="panel-icon">
									<img src="<?=url('_assets/img/order.png')?>" alt="order" height="48">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card">
						<div class="card-body">
							<div class="card-panel">
								...
								<div class="panel-icon">
									<img src="<?=url('_assets/img/paket.png')?>" alt="paket" height="48">
								</div>
							</div>
